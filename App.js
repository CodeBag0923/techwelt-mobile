...
async function registerForPushNotificationsAsync() {
  ...
  if (true) {
    const { status: existingStatus } =
      await PushNotifications.getPermissionsAsync();
    ...
    token = (
      await PushNotifications.getExpoPushTokenAsync({
          ...
          tabBarIcon: ({ color, size }) =>
            color == "white" ? (
              <Image
                ...
                source={require("./assets/tab_list_sel.png")}
              ></Image>
            ) : (
              <Image
                style={{
                ...
                source={require("./assets/tab_list_desel.png")}
              ></Image>
            ),
        }}
      />
          ...
          tabBarIcon: ({ color, size }) =>
            color == "white" ? (
              <Image
                ...
                source={require("./assets/tab_dashboard_sel.png")}
              ></Image>
            ) : (
              <Image
                style={{
                ...
                source={require("./assets/tab_dashboard_desel.png")}
              ></Image>
            ),
        }}
      />
          ...
          tabBarIcon: ({ color, size }) =>
            color == "white" ? (
              <Image
                ...
                source={require("./assets/tab_map_sel.png")}
              ></Image>
            ) : (
              <Image
                style={{
                ...
                source={require("./assets/tab_map_desel.png")}
              ></Image>
            ),
        }}
      />
            ...
            color == "white" ? (
              <View>
                <Image
                  ...
                  source={require("./assets/tab_alert_sel.png")}
                ></Image>
                <View
                  style={{
                    position: "absolute",
              ...
              <View>
                <Image
                  ...
                  source={require("./assets/tab_alert_desel.png")}
                ></Image>
                <View
                  style={{
                    position: "absolute",
          ...
          tabBarIcon: ({ color, size }) =>
            color == "white" ? (
              <Image
                ...
                source={require("./assets/tab_profile_sel.png")}
              ></Image>
            ) : (
              <Image
                style={{
                ...
                source={require("./assets/tab_profile_desel.png")}
              ></Image>
            ),
        }}
      />
